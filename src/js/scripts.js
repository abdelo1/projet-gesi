...
$(function(){
        ...
        timeup.hide()
        countDownDate = new Date($('.prochainm').attr('data-dhm')).getTime();
    setInterval(function() {
        ...
        if(days<10)
            $("#jours").text("0"+days+" jrs") 
        else
            $("#jours").text(days+" jrs")
        if(hours<10)
            $("#heures").text("0"+hours+" hr") 
        else
            $("#heures").text(hours+" hr")
        if(minutes<10)
            $("#minutes").text("0"+minutes+" min") 
        else   
            $("#minutes").text(minutes+" min")
        if(seconds<10)
            $("#secondes").text("0"+seconds+" sec") 
        else   
            $("#secondes").text(seconds+" sec")
